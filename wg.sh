...
echo -e "${Info} Wireguard VPS AutoScript by arlanstore"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/arlanstore/anu/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/arlanstore/anu/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/arlanstore/anu/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/arlanstore/anu/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
